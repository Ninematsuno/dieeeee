...
from TGNRobot.modules.sql import users_sql as sql
...
PM_START_TEXT = """
Hᴜ-ᴛᴀᴏ (胡桃) ɪs ᴀ Cʜɪɴᴇsᴇ Gᴇɴsʜɪɴ ɪᴍᴀᴘᴀᴄᴛ Cʜᴀʀᴀᴄᴛᴇʀ 
⥈❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖⥈
𝐀𝐧 𝐚𝐧𝐢𝐦𝐞 𝐛𝐚𝐬𝐞𝐝 𝐂𝐮𝐭𝐞 𝐚𝐧𝐝 𝐀𝐝𝐯𝐚𝐧𝐜𝐞𝐝 𝐆𝐫𝐨𝐮𝐩 𝐌𝐚𝐧𝐚𝐠𝐞𝐦𝐞𝐧𝐲 𝐁𝐨𝐭 𝐟𝐫𝐨𝐦
➲ Gᴇɴsʜɪɴ ɪᴍᴘᴀᴄᴛ (Gᴀᴍᴇ)
ʙʏ Wᴇᴇʙs...
⥈❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖⥈
⤚━━━━━━━━━━━━━━━━━━━━━━━━⤙[.](https://telegra.ph/file/4f54efa85d44567fbbee4.jpg)
𝚞𝚜𝚎 𝚝𝚑𝚎 𝚋𝚞𝚝𝚝𝚘𝚗𝚜 𝚋𝚎𝚕𝚘𝚠 𝚝𝚘 𝚔𝚗𝚘𝚠 𝚖𝚘𝚛𝚎 𝚊𝚋𝚘𝚞𝚝 𝚖𝚎 𝚘𝚛 𝚢𝚘𝚞 𝚌𝚊𝚗 𝚞𝚜𝚎 /help 𝚝𝚘 𝚐𝚘 𝚝𝚑𝚛𝚘𝚞𝚐𝚑 𝚃𝚑𝚎 𝙶𝚎𝚗𝚜𝚑𝚒𝚗 𝚐𝚞𝚒𝚍𝚎
⤚━━━━━━━━━━━━━━━━━━━━━━━━⤙
⍟ protecting group since `{}`,
≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡
"""

buttons = [
    [
        InlineKeyboardButton(text="✐ ᴀᴅᴅ ʜᴜ ᴛᴀᴏ", url="t.me/HUTAO_PRO_BOT?startgroup=true"),  
        InlineKeyboardButton(text="Qᴜɪᴄᴋ sᴇᴛᴜᴘ ", url="https://t.me/hu_tao_updates/4"),
    ],
    [
        InlineKeyboardButton(text="ꜱᴜᴘᴘᴏʀᴛ ⚡", url=f"https://t.me/{SUPPORT_CHAT}"),            
        InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇꜱ ☑️", url=f"https://t.me/hu_tao_updates"),
    ],
    [
        InlineKeyboardButton(text="Gᴇɴsʜɪɴ ɢᴜɪᴅᴇ", callback_data="help_back"),
        InlineKeyboardButton(text="☆ Aɴɪᴍᴇ ᴄʜᴀᴛ ✩", url="https://t.me/the_code_breakers"),
    ],
]
...
✪ /help: Click this, I'll let you know about myself!
   ...
   ◔ in a Group: will redirect you to pm, with all that chat's settings[.](https://telegra.ph/file/fbba0768d7abfe8517d4a.jpg)"""
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_video(
            START_IMG, caption= "<code>HU TAO is Here For You❤\nI am Awake Since</code>: <code>{}</code>".format(
                uptime            
            ),
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[I am now online🔪](https://telegra.ph/file/53697789f556c851e6fa7.mp4)",parse_mode = ParseMode.MARKDOWN ),
        except Unauthorized:
            LOGGER.warning(
